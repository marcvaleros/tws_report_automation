...
const UserList = () => {
  ...
  return (
    <div className='flex flex-col space-y-4 md:mx-0 sm:mx-4'>
      <h2 className="text-2xl font-bold pl-2 text-[#007DB8]">Subscribed Users</h2> 
      <div className="relative overflow-x-auto shadow-md rounded-md bg-white mx-2 cursor-pointer">
        {users?.length > 0 ? (
